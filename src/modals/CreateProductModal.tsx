...
import { getAllCodeProductService, getAllCodeConditionService, handleCreateProductAction } from '@/app/action';
...
const CreateProductModal = (props: any) => {
    const { show, setShow, getDataProduct } = props;
    ...
    const handleSubmitCreate = async () => {
        const res = await handleCreateProductAction(product);
        if (res && res.EC === 0) {
            handleClose();
                        ...
                        <Row className="mb-3">
                            ...
                            <Col md={6}>
                                <Form.Group controlId="exampleForm.ControlInput1">
                                    ...
                                    <Form.Select onChange={(event) => handleSelectChange("type_product", event)}>
                            ...
                            <Col md={6}>
                                <Form.Group controlId="exampleForm.ControlInput1">
                                    ...
                                    <Form.Select onChange={(event) => handleSelectChange("type_condition", event)}>
